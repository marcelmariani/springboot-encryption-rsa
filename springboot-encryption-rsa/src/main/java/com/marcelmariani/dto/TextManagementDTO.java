...
public class TextManagementDTO {
	...
	public TextManagementDTO(TextManagement textManagement) {
		this.uuid = textManagement.getUuid();
		this.textData = textManagement.getTextData();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TextManagementDTO other = (TextManagementDTO) obj;
